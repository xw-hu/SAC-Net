...
model_root_dir = 'xxx/xxx/examples/SAC-Net/xxx/';
definition_file = [model_root_dir 'deploy.prototxt'];
binary_file = [model_root_dir 'snapshot/' 'SAC-Net_iter_50000.caffemodel'];
...
image_list1 = textread('/xxx/xxx/data/ECSSD/test.txt', '%s');

image_list2 = textread('/xxx/xxx/data/DUTS/test.txt', '%s');

image_list3 = textread('/xxx/xxx/data/DUT-OMRON/test.txt', '%s');

image_list4 = textread('/xxx/xxx/data/HKU-IS/test.txt', '%s');

image_list5 = textread('/xxx/xxx/data/PASCAL-S/test.txt', '%s');

image_list6 = textread('/xxx/xxx/data/SOD/test.txt', '%s');

root_dir = {'/home/xwhu/dataset/ECSSD/images_ECSSD/', ...
    '/xxx/xxx/dataset/DUTS/duts/', ...
    '/xxx/xxx/dataset/DUT-OMRON/DUT-OMRON-image/', ...
    '/xxx/xxx/dataset/HKU-IS/imgs/', ...
    '/xxx/xxx/dataset/PASCAL-S/input/', ...
    '/xxx/xxx/dataset/SOD/image/'};
...
for set = 1:6
    ...
    fprintf('Dataset: %s, idx %i/%i, avgtime=%.4fs\n', char(dataset(set)),k,nImg,avgtime);
